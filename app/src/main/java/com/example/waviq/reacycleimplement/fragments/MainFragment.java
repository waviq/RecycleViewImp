...
public class MainFragment extends Fragment {
    ...
    @Override
    /*
        method untuk nampilin view fragmen di main activity
    */
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fm.beginTransaction().add(R.id.container_midle_row, stationsFragment2).commit();

        stationsFragment3 = StationsFragment.newInstance(StationsFragment.STATION_TYPE_PARTY);
        fm.beginTransaction().add(R.id.container_buttom_row, stationsFragment3).commit();
